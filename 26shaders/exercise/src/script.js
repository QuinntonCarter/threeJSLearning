...
// creates new attribute named aRandom, type of THREE.BufferAttribute()
...
const material = new THREE.RawShaderMaterial({
    ...
    // allows add of custom uniforms
    uniforms: {
        uFrequency: {
            // old code provides type (vec3, vec2, etc) but can just provide value
